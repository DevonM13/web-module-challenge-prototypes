...
mary.eat('chicken parm');
mary.eat('penne pasta');
mary.eat('garlic bread');
...
// const car = new Car('WRX', 20)
// car.fill(15);
// console.log(car, car.fill);
...
/* 
  ...
  1. Window Binding - when none of the other rules apply, this will return the window or global object in node or undefined in strict node.
